...
flags = flags + ['-I', os.path.abspath('./include/')]
flags = flags + ['-I', os.path.abspath('./lib/')]


pwd = os.path.abspath(os.getcwd())
while os.path.basename(pwd) != 'src' and os.path.basename(pwd) != 'include':
  pwd = os.path.dirname(pwd)
  if pwd == '/':
    break
pwd = os.path.dirname(pwd)
if pwd != '/':
  flags = flags + ['-I', os.path.abspath(os.path.join(pwd, 'include'))]
